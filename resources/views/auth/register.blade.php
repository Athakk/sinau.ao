...
<head>
    ...
    <title>Registrasi Akun | Sinau.ao</title>
            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center">
                    ...
                    <form action="{{ route('registerStore') }}" method="post">
                        ...
                        <div class="input-group mb-3">
                            <button type="submit" class="btn btn-lg btn-primary w-100 fs-6 fw-bold">Daftar Sekarang</button>
                        </div>
                    </form>
                    <div class="regist mb-3 text-center">
                        <p class="text-secondary">Sudah punya akun? <a href="/login" class="text-decoration-none fw-bold" style="color: var(--sinau-green);">Masuk di sini</a></p>
                    </div>
                </div>
            </div>
        </div>
