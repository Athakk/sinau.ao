        ...
        <div class="row border rounded-5 p-3 bg-white shadow box-area">
            ...
            <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box"
                ...
                <div class="featured-image mb-3">
                    <img src="{{ asset('frontuser/gambar/sinauuu.png') }}" class="img-fluid rounded-4"
                        style="max-width: 100%;">
                </div>
            </div>
            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center">
                    ...
                    <form action="{{ route('createRegister') }}" method="post">
                        ...
                        <div class="input-group mb-3">
                            <button type="submit" class="btn btn-lg btn-primary w-100 fs-6 fw-bold">Daftar
                                Sekarang</button>
                        </div>
                    </form>
                    <div class="regist mb-3 text-center">
                        <p class="text-secondary">Sudah punya akun? <a href=" {{ route('login') }}"
                                class="text-decoration-none fw-bold" style="color: var(--sinau-green);">Masuk di
                                sini</a></p>
                    </div>
                </div>
            </div>
