<footer class="text-light py-5" style="background-color: #1a1a1a;">
    <div class="container px-lg-4">
        <div class="row gy-4">

            <div class="col-lg-5 mb-4 mb-lg-0">
                <a href="#" class="d-inline-block mb-4">
                    <img src="{{ asset('frontuser/gambar/sinau.ao.png') }}" alt="Logo Sinau.ao" height="50">
                </a>
                ...
                <div class="d-flex align-items-center small text-white-50">
                    <i class="bi bi-telephone-fill me-3 text-white fs-6"></i>
                    <span>+62 888-7777-9999</span>
                </div>
            </div>
        ...
        <div class="row align-items-center">
            <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                <p class="small text-white-50 mb-0">&copy; 2025 Sinau.ao. All Rights Reserved.</p>
            </div>
        </div>
    </div>
</footer>
